...
<html>
  ...
  <body>
      ...
      <main>
        ...
        <form id="credentials"> 
          <fieldset>
            <div id="oauthForm" style="display: block;">
        ...
        <form id="registerForm">
          <fieldset>
            ...
            <input id="register" title="register" type="submit" value="register" disabled="disabled">
            <input id="unregister" title="unregister" type="submit" value="unregister" disabled="disabled">
          </fieldset>
        </form>
