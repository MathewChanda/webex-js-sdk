...
function handleAuthTypeChange() {
  ...
  if (isToken) {
    ...
    document.getElementById('webexInit').addEventListener('click', (event) => {
      ...
      // Re-initializing the sdk to authorize with the paste access token because
      // the process is slightly different for pasting access token and oauth
...
document.getElementById('unregister').addEventListener('click', () => {
  ...
  document.getElementById('register').disabled = false;
  document.getElementById('register-status').innerText = 'not registered';
