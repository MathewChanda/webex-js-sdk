...
let webex = window.webex = Webex.init({
  config: {
    ...
    credentials: {
      client_id: 'C3f88bd751d4fe5a066cb7134567bf3a2f2ac02a329a83d48ca5d247ae915a790',
      redirect_uri,
...
function handleRadio() {
  ...
  if (isOAuth) {
    ...
    legend.innerHTML = 'Authentication with OAuth';
  ...
  if (isPaste) {
    ...
    legend.innerHTML = 'Authentication with Access Token';
